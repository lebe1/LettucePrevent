...
RQ1_DIR="${REPO_DIR}"
RESULTS_DIR="${RESULTS_DIR:-/share/${USER}/rq2-beam4-results}"
...
WANDB_PROJECT="${WANDB_PROJECT:-hdm-rq2-beam4}"
# 3 generators x 1 detectors x 4 skip thresholds + 3 generators x 1 baseline = 15 cells
SWEEP_COUNT="${SWEEP_COUNT:-15}"
N_PER_TASK="${N_PER_TASK:-20}"
POST_EVAL_FLOOR="${POST_EVAL_FLOOR:-0.70}"
OUTPUT_PREFIX="${OUTPUT_PREFIX:-rq2_beam4}"
