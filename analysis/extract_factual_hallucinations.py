...
if __name__ == "__main__":
    input_file = "../data/factual_hallucinations/summary_experiments_tinylettuce_run_20251221_155808.json"
    
    # Extract timestamp from input filename
    timestamp = re.search(r'run_(\d{8}_\d{6})', input_file).group(1)
    
    json_output_file = f"../data/factual_hallucinations/hallucinations_experiments_LettuceDetect_{timestamp}.json"
    stats_output_file = f"../data/factual_hallucinations/hallucination_stats_LettuceDetect_{timestamp}.txt"
